...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    Attention_Layer = NeuralNets.causal_multihead_self_attention_with_rope(d_model=d_model, num_heads=num_heads, max_sequence_length=max_seq_len)
    weights = {'w_q.weight': q_proj_weight, 'w_k.weight': k_proj_weight, 'w_v.weight': v_proj_weight, 'w_o.weight': o_proj_weight}
    Attention_Layer.load_state_dict(weights)
...
def run_transformer_lm(
    ...
    """
    LM = NeuralNets.transformer_lm(vocab_size=vocab_size, d_model=d_model, d_ff=d_ff, num_heads=num_heads, num_blocks=num_layers, context_length=context_length, theta=rope_theta)
...
def run_get_batch(
    ...
    """
    f = NeuralNets.get_batch
    return f(dataset, batch_size, context_length, device)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    f = NeuralNets.Softmax
    return f(in_features, dim)
...
def run_cross_entropy(
    ...
    """
    return NeuralNets.cross_entropy_loss(inputs, targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    return NeuralNets.gradient_clipping(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return NeuralNets.cosine_lr_schedule(it, min_learning_rate, max_learning_rate, warmup_iters, cosine_cycle_iters)
